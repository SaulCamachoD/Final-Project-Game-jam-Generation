...
{
    // Array para m�ltiples puntos de spawneo
    ...
    protected override void Shoot()
    {
        ...
        // Activamos las part�culas en el punto de spawneo actual
        Fire.transform.position = firePoint.position; // Mover las part�culas al punto de spawneo actual
        Fire.Play();
    }
}
